...
import de.muenchen.mailmerge.print.MailMerge;
import de.muenchen.mailmerge.print.OOoBasedMailMerge;
import de.muenchen.mailmerge.print.PrintFunction;
import de.muenchen.mailmerge.print.PrintFunctionLibrary;
import de.muenchen.mailmerge.print.PrintIntoFile;
...
public class StandardPrint
{
  ...
  public static void myTestPrintFunction(XPrintModel pmod, Object arg)
  {
    ...
    if (arg != null && arg instanceof ConfigThingy)
      conf = (ConfigThingy) arg;
