...
/**
 * Erzeugt ein neues WollMuxEvent, das signasisiert, dass die neue Seriendruckfunktion des WollMux gestartet werden soll.
 * 
 * Das Event wird über den DispatchHandler aufgerufen, wenn z.B. über das Menü "Extras->Seriendruck (WollMux)" die dispatch-url
 * wollmux:SeriendruckNeu abgesetzt wurde.
 */
public class OnSeriendruck extends BasicEvent
{
  ...
  protected void doit() throws MailMergeFehlerException
  {
    ...
    MailMergeNew mmn = new MailMergeNew(documentController, actionEvent -> {
